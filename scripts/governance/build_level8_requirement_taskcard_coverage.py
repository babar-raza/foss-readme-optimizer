...
def task_stage_goal(task_id: str) -> tuple[str, str]:
    ...
    if task_id == "L8-PF-00-CAMPAIGN-AUTHORITY-RECONCILIATION":
    ...
    if task_id == "L8-PF-04-MINIMAL-GRAPH-RUNNER":
        return "GOAL-V0B-POST-PYTHON-SLICES", "primary_only"
    if task_id == "L8-PF-05-SEVEN-ECOSYSTEM-CANARIES":
        return "GOAL-V0B-POST-PYTHON-SLICES", "repository_local_write_isolated"
    if task_id == "L8-PF-06-REGISTRY-FREEZE-AND-FACT-WARMUP":
        return "GOAL-C0-AUTHORIZED-PORTFOLIO", "read_only_assurance_isolated"
    if task_id == "L8-PF-07-AUTONOMOUS-PUBLICATION-READINESS":
    ...
    if task_id == "L8-FRESH-00-FRESHNESS-SERVICE":
        return "GOAL-V0B-POST-PYTHON-SLICES", "repository_local_write_isolated"
    if task_id == "L8-PORT-01-LOCAL-README-PORTFOLIO-ASPOSE-PARITY":
        return "GOAL-V0B-POST-PYTHON-SLICES", "repository_local_write_isolated"
...
PREFIX_TO_TASK = {
    ...
    "KNOW": "L8-PF-01-KNOWLEDGE-ACCEPTANCE-IDENTITY",
...
L8_TO_TASK = {
    "KNOW-007": "L8-WAVE4-PRESENTATION-INTELLIGENCE",
    "KNOW-008": "L8-WAVE4-PRESENTATION-INTELLIGENCE",
    "KNOW-009": "L8-WAVE4-PRESENTATION-INTELLIGENCE",
    "KNOW-010": "L8-TRUTH-07-SEVEN-ECOSYSTEMS",
    "KNOW-011": "L8-WAVE4-PRESENTATION-INTELLIGENCE",
    "AUTH-008": "TRP-05C-GITHUB-APP-HOSTED-QUALIFICATION",
    "NFR-014": "TRP-04P-TEST-LATENCY",
    "RDM-018": "L8-PF-02-COMPLETE-CANDIDATE-SEAM",
    "RDM-026": "L8-PORT-01-LOCAL-README-PORTFOLIO-ASPOSE-PARITY",
    "PIL-011": "L8-PF-06-REGISTRY-FREEZE-AND-FACT-WARMUP",
    "PIL-015": "L8-PORT-01-LOCAL-README-PORTFOLIO-ASPOSE-PARITY",
    "FACT-014": "L8-PF-06-REGISTRY-FREEZE-AND-FACT-WARMUP",
