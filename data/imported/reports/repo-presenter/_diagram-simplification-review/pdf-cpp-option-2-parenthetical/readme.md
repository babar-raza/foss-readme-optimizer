<!-- REVIEW VARIANT — Option 2: "open existing" and "create from scratch" as two explicit peer capabilities. Not a real candidate, not pushed anywhere. Only the ## At a glance section differs from reports/repo-presenter/pdf/cpp/readme.md. -->
...
flowchart TD
  ...
  subgraph CAP["Core Capabilities"]
    direction TB
    C1["Open an existing PDF document (including encrypted)"]
    C2["Create a new PDF document from scratch"]
    C3["Text extraction and page rendering"]
    C4["Encryption and digital signing"]
    C5["Facades: convert, extract, secure, sign, bookmark"]
  end
