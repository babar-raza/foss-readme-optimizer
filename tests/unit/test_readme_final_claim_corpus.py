...
def _case(platform: str):
    ...
    return source, candidate, facts, accountability
...
def test_real_source_and_candidate_claim_inventories_are_complete(platform: str):
    source, candidate, _facts, accountability = _case(platform)
...
def test_real_corpus_freezes_parity_performance_format_installation_and_example_controls():
    python_source, python_candidate, _python_facts, python_map = _case("python")
    typescript_source, _typescript_candidate, _typescript_facts, typescript_map = _case(
        "typescript"
    )
...
def test_preservation_and_regeneration_do_not_hide_missing_accountability():
    _source, _candidate, facts, _accountability = _case("python")
