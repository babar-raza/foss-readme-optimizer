...
def test_intake_boundary_accepts_intake_ready_and_later_stages():
    assert evaluate_stage_boundary("INTAKE_READY", "INTAKE_READY").reached is True
    assert evaluate_stage_boundary("INTAKE_READY", "FACTS_READY").reached is True
    assert evaluate_stage_boundary("INTAKE_READY", "NO_OP_PROVEN").reached is True
    assert evaluate_stage_boundary("INTAKE_READY", "INTAKE_PREFLIGHTING").reached is False
