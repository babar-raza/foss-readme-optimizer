...
The handover snapshot was `main` at `e454f7ff1a9885a87b54be59585ebf6f358b4912`, state
...
snapshot, one canonical worker was running from the resume-10 checkpoint:
...
`runs/level8-local-full-registry-gate-a-live-resume-10/`, repair each agent-fixable repository at
