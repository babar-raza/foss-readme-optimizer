...
IMPLEMENTATION_PATHS = (
    ...
    "src/readme_agent/facts/example_quality.py",
    ...
    "src/readme_agent/facts/python_example_normalization.py",
...
FOCUSED_COMMAND = (
    ...
    "tests/unit/test_dotnet_public_types.py",
    "tests/unit/test_example_quality.py",
    "tests/unit/test_python_example_normalization.py",
    "tests/unit/test_python_example_verifier.py",
