...
| `readme/header_visual_layout.py`, `readme/header_visual_mermaid.py`, `readme/header_visual_validation.py` | Own the responsive Mermaid capability layout, common-width endpoint labels, source rendering, and independent structural validation: one compact vertical capability column through five entries and two balanced columns above five. |
