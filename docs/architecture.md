...
| `facts/aspose_knowledge_claims.py`; `facts/aspose_knowledge_selection.py`; `readme/knowledge_claim_presentation.py`; `facts/knowledge_application_evidence.py`; `facts/aspose_seo_keyword_facts.py` | Decision 106's native knowledge-application layer — load/index, freshness-gate, bound-select, safely render, and item-coordinate evidence the imported aspose.org claim corpus and SEO keyword lists into `ProductFactsV2`; see "Native knowledge-application layer" above. |
