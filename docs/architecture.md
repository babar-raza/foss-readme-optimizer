...
| `readme/document_section_journey.py` | Consolidates inherited Why/Features variants into one loss-bounded `Key capabilities` section after the overview, preserving extra source material in disclosures and deriving missing visible capability claims only from accepted fact render views. |
