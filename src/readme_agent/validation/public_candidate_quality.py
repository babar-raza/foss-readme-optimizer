...
PUBLIC_QUALITY_CHECKS_VERSION = 1
...
def _check_contradiction_capability_phrase(
    ...
    for positive_line in positive_lines:
        for negative_line in negative_lines:
            ...
            if shared:
                blocking = True
            elif same_public_capability(positive_line.text, negative_line.text):
                blocking = False
            else:
                continue
            locations = (
...
_CHECKS_SOURCE_HASH_AT_VERSION = "09665210c324ba14f0ed37cfae965d02f0fd83499db505fb8ded99b5225d8dd2"
