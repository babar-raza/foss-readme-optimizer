...
def cmd_generate(args: argparse.Namespace) -> int:
    ...
    print(f"  llm_called={result.llm_called}, gaps={result.gap_report.gaps}")
...
def cmd_run(args: argparse.Namespace) -> int:
    ...
    result = run_repo(args.repo, mode=args.mode, force_regenerate=args.force_regenerate)
    print(
...
def cmd_run_registry(args: argparse.Namespace) -> int:
    ...
    results = run_registry(only=only)
