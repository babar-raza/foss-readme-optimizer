...
SURFACE_DEPENDENCIES = {
    ...
    "installation.optional_extras": ["readme.installation", "readme.development"],
    "installation.capability_dependencies": ["readme.installation", "readme.api_reference"],
    "python.distribution": ["readme.installation", "readme.release"],
    ...
    "repository.security_guidance": ["readme.security"],
    "repository.contribution_guidance": ["readme.contributing"],
    "repository.third_party_notices": ["readme.third_party_notices"],
    "repository.ci": ["readme.header"],
