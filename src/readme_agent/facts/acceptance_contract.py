...
_COMPONENT_FILES: dict[str, tuple[str, ...]] = {
    ...
    "imported_knowledge": (
        ...
        "knowledge_source_polarity.py",
        "presentation_knowledge.py",
        "presentation_knowledge_schema.py",
        "python_evidence_polarity.py",
        "aspose_detectors.py",
        "repository_knowledge_adapter.py",
        "repository_knowledge_generator.py",
        "aspose_org_vendored_source.py",
        "../../../data/imported/knowledge_manifest.json",
        "../../../data/imported/aspose_org_knowledge_generator_manifest.json",
        "../../../data/imported/presentation_knowledge.json",
    ),
    "aspose_checks": (
        ...
        "../vendored_asposeorg/scripts/pipeline/lib/api_table_dupes.py",
        "../../../data/aspose_check_classification.json",
        "../../../data/imported/aspose_org_check_battery_manifest.json",
    ),
    "dependency_evidence": (
