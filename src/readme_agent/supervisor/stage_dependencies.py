...
_CANDIDATE_DEPENDENCY_GROUPS: dict[
    ...
    "composition_semantics": (
        ...
        (
            ...
            "src/readme_agent/readme/format_role_truth.py",
            "src/readme_agent/readme/opening_summary_fallback.py",
        ),
    ),
    "bounded_section_authoring": (
        "severe_acceptance",
        "PLAN_READY",
        (
            "src/readme_agent/llm/section_authoring_prompts.py",
            "src/readme_agent/readme/section_authoring_specs.py",
            "src/readme_agent/readme/section_cluster_planner.py",
            "src/readme_agent/specialists/section_authoring_cache.py",
            "src/readme_agent/specialists/section_authoring_contracts.py",
            "src/readme_agent/specialists/section_authoring_document.py",
            "src/readme_agent/specialists/section_authoring_packet.py",
            "src/readme_agent/specialists/section_authoring_store.py",
            "src/readme_agent/specialists/section_cluster_authoring.py",
        ),
    ),
    ...
    "source_claim_accountability": (
        ...
        (
            ...
            "src/readme_agent/presentation/verified_compiled_example_omission.py",
            "src/readme_agent/presentation/verified_source_claim_omissions.py",
            "src/readme_agent/presentation/verified_source_claim_pair_resolution.py",
    ...
    "stage_bundle_persistence": (
        ...
        (
            ...
            "src/readme_agent/specialists/bounded_review_coverage.py",
            "src/readme_agent/specialists/bounded_review_evidence.py",
            "src/readme_agent/specialists/bounded_review_hashing.py",
